...
Players <- read.csv(textConnection(getURL("https://raw.githubusercontent.com/samperochkin/tennis-analytics/master/Data/Raw/Players.txt")), header = FALSE)
T2010 <- read.csv(textConnection(getURL("https://raw.githubusercontent.com/samperochkin/tennis-analytics/master/Data/Raw/T2010.txt")), header = FALSE)

...
data_summarised[, ave_pts_game := (`1stWon_365` + `2ndWon_365` + rpt_won_365)/(win_Clay_365 + loss_Clay_365 + win_Grass_365 + loss_Grass_365 + win_Hard_365 + loss_Hard_365)]
...
data_summarised[(win_Clay_365 + loss_Clay_365) == 0, perc_win_clay := 0]
data_summarised[(win_Grass_365 + loss_Grass_365) == 0, perc_win_grass := 0]
data_summarised[(win_Hard_365 + loss_Hard_365) == 0, perc_win_hard := 0]
data_summarised[(win_Clay_365 + loss_Clay_365 + win_Grass_365 + loss_Grass_365 + win_Hard_365 + loss_Hard_365) == 0, ave_pts_game := 0]

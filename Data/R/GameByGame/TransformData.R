...
data_transformed[win == 1 & !is.na(score_set_1), score_set_1 := substr(score_set_1, 1, 1)]
data_transformed[win == 1 & !is.na(score_set_2), score_set_2 := substr(score_set_2, 1, 1)]
data_transformed[win == 1 & !is.na(score_set_3), score_set_3 := substr(score_set_3, 1, 1)]
data_transformed[win == 1 & !is.na(score_set_4), score_set_4 := substr(score_set_4, 1, 1)]
data_transformed[win == 1 & !is.na(score_set_5), score_set_5 := substr(score_set_5, 1, 1)]

data_transformed[win == 0 & !is.na(score_set_1), score_set_1 := substr(score_set_1, 3, 3)]
data_transformed[win == 0 & !is.na(score_set_2), score_set_2 := substr(score_set_2, 3, 3)]
data_transformed[win == 0 & !is.na(score_set_3), score_set_3 := substr(score_set_3, 3, 3)]
data_transformed[win == 0 & !is.na(score_set_4), score_set_4 := substr(score_set_4, 3, 3)]
data_transformed[win == 0 & !is.na(score_set_5), score_set_5 := substr(score_set_5, 3, 3)]
